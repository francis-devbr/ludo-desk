...
Public Class frmTransportadora
    ...
    Private Sub ModoPesquisa()
        ...
        With frmMenu.lblInfoTela
            .Text = "Pesquisa de Transportadoras"
            .Visible = True
        End With
    ...
    Private Sub SoNumero(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtNrLog.KeyPress, txtDDD.KeyPress, txtTel.KeyPress, txtCep.KeyPress, txtCNPJ.KeyPress, txtCelCont.KeyPress, txtDDDTelCont.KeyPress
        If Not Char.IsNumber(e.KeyChar) And Not e.KeyChar = vbBack Then
            e.Handled = True
        End If
    End Sub

    Private Sub frmTransportadora_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub frmTransportadora_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        RzPesquisado = Nothing
        CNPJPesquisado = Nothing
        nmFantasia = Nothing
    End Sub

    Private Sub frmTransportadora_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If My.Computer.Network.IsAvailable = True Then
            btnPOnline.Visible = True
    ...
    Private Sub CarregarListView()
        ...
        Dim objClsTransportadora As New clnTransportadora
        Dim ds As Data.DataSet = objClsTransportadora.Lista((Regex.Replace(Me.txtPNome.Text, "[\\\?\*-./]", "")))
        ...
        For i As Integer = 0 To dtable.Rows.Count - 1
            ...
            If mModoForm = clnFuncoesGerais.ModoForm.ModoCadastro Then
                If drow.RowState <> DataRowState.Deleted Then
                    Dim lvi As New ListViewItem(drow("cdTransp").ToString())
    ...
    Private Sub CarregaPesquisa()
        ...
        drDados = objClsTransportadora.ListarTRANSPORTADORA(codigo)
        ...
        If drDados.Read Then
            ...
            Me.txtDDDTelCont.Text = drDados("DDDCel").ToString.Trim
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        ...
        With objClsTransportadora
            ...
            .DDDCel = txtDDDTelCont.Text.ToString.Trim
            .Celular = Regex.Replace(Me.txtCelCont.Text, "[\\\?\*-./]", "").ToString.Trim
            .DtCad = DateTime.Now
            .Ativo = Ativo

            If mOperacao = clnFuncoesGerais.IncluirAlterar.Inclusao Then
                objClsTransportadora.Gravar()
                Dim drDados As System.Data.SqlClient.SqlDataReader
                drDados = objClsTransportadora.CarregaCod(Regex.Replace(Me.txtCNPJ.Text, "[\\\?\*-./]", "").ToString.Trim)
                If drDados.Read Then
                    codigo = CInt(drDados("cdTransp"))
                End If
            ...
            ElseIf mOperacao = clnFuncoesGerais.IncluirAlterar.Alteracao Then
                objClsTransportadora.Codigo = CInt(codigo)
                objClsTransportadora.Alterar()
